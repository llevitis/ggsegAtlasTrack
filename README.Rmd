...
# ggsegAtlas <img src='man/figures/logo.png' align="right" height="138.5" />

<!-- badges: start -->
<!-- badges: end -->

This package contains dataset for plotting the [atlas](add url here) atlas ggseg and ggseg3d. 
...
install.packages('ggsegAtlas')
```

You can install the released version of ggsegAtlas from [GitHub](https://github.com/) with:

``` r
# install.packages("remotes")
remotes::install_github("ggseg/ggsegAtlas")
```
...
Please note that the 'ggsegAtlas' project is released with a
